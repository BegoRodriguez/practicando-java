...
class TiposPrimitivos {
  ...
  /* Desbordamiento (underflow) - Ocurre cuando sobrepasamos el limite de nuestras primitivas */
            int q = Integer.MIN_VALUE;
            int p = q - 1;  // Cuando un entero se desborda, vuelve al valor mínimo y comienza a contar desde allí.
            System.out.println("Valor minimo entero: " + q + " Operación desbordada " + p); // La variable 'j' volverá a -2147483648
            

            double d = Double.MAX_VALUE;
            double o = d + 1; // Los números en coma flotante se pueden desbordar devolviendo un redondeo 
            System.out.println("Valor maximo double: " + d + " Operación desbordada redondeada " + o);  // La variable 'o' será el valor máximo

            double o2 = d * 1000; // Los números en coma flotante se desbordan devolviendo Infinito
